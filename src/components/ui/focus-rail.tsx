            ...
            <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
                    ...
                    {visibleIndices.map((offset) => {
                        ...
                        return (
                            <motion.div
                                key={absIndex}
                                className={cn(
                                    "absolute aspect-[3/4] w-[260px] md:w-[300px] rounded-2xl border-t border-white/20 bg-[#0a0a12]/90 shadow-2xl transition-shadow duration-300",
                ...
                <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                {activeItem.description && (
                                    <p className="max-w-md text-[#8AB4F8]/60">
                                        {activeItem.description}
                                    </p>
                                )}
                            </motion.div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-1 rounded-full bg-[#0a0a12]/80 p-1 ring-1 ring-white/10 backdrop-blur-md">
                            <button
                                onClick={handlePrev}
                                className="rounded-full p-3 text-[#8AB4F8]/60 transition hover:bg-white/10 hover:text-white active:scale-95"
                                aria-label="Previous"
                            >
                                <ChevronLeft className="h-5 w-5" />
                            </button>
                            <span className="min-w-[40px] text-center text-xs font-mono text-[#8AB4F8]/50">
                                {activeIndex + 1} / {count}
                            </span>
                            <button
                                onClick={handleNext}

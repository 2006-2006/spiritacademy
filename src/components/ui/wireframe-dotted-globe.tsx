...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
    ...
    if (error) {
        return (
            <div className={`flex items-center justify-center bg-[#0a0a12]/80 rounded-2xl p-8 ${className}`}>
                <div className="text-center">
                    <p className="text-red-400 font-semibold mb-2">Error loading Earth visualization</p>
                    <p className="text-[#8AB4F8]/40 text-sm">{error}</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            />
            <div className="absolute bottom-4 left-4 text-xs text-[#8AB4F8]/60 px-2 py-1 rounded-md bg-[#0a0a12]/80">

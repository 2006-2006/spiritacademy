    ...
    const initialCards: Card[] = [
        {
            ...
            alt: "AI Architect",
            title: "AI Architect",
            description: "Master-level certification in AI architecture and neural network design"
        },
        {
            id: 2,
            src: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=800&fit=crop",
            alt: "Full-Stack Mastery",
            title: "Full-Stack Mastery",
            description: "Complete mastery of modern web development stack and cloud architecture"
        },
        {
            id: 3,
            ...
            description: "Built and deployed a production-grade neural network for image recognition"
        },
        {
            id: 4,
            ...
            alt: "Top 1% Learner",
            title: "Top 1% Learner",
            description: "Ranked in top 1% of global learners for completion rate and skill mastery"
        },
        {
            id: 5,
            src: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=800&fit=crop",
            alt: "Data Science Pro",
            title: "Data Science Pro",
            description: "Advanced certification in data science, ML algorithms, and statistical analysis"
        },
        {
            id: 6,
            ...
            description: "Expert-level skills in AWS, Azure, and Google Cloud Platform architecture"
        }
    ];
        ...
        <div className="w-full h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute top-8 left-8 right-8 flex items-center justify-between z-30">
                <div className="flex gap-2">
                    <motion.button
                        onClick={resetCards}
                        className="p-3 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors duration-200"
            ...
            <motion.button
                onClick={moveToStart}
                className="absolute left-8 top-1/2 -translate-y-1/2 p-4 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors duration-200 z-20"
            ...
            <motion.button
                onClick={moveToEnd}
                className="absolute right-8 top-1/2 -translate-y-1/2 p-4 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors duration-200 z-20"
                whileHover={{ scale: 1.1, x: 5 }}
                whileTap={{ scale: 0.9 }}
            >
            ...
            <div className="relative w-80 aspect-[3/4] overflow-visible z-10">
